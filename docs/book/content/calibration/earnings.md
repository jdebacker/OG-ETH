...
and where, $e^{PHL}$, when applied to the population distribution of Ethiopia, returns a Gini coefficient that matches the observed Gini coefficient for Ethiopia, 31.1.
